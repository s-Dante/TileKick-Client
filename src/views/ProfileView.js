...
export class ProfileView extends Component {
    ...
    render() {
        ...
        const styles = {
            ...
            heroSection: "bg-bg-secondary-opaque rounded-2xl p-6 border border-border-primary shadow-lg flex flex-col md:flex-row items-center md:items-start gap-6 relative overflow-hidden",
            heroGlow: "absolute top-0 right-0 w-32 h-32 bg-accent-primary/10 rounded-full blur-3xl -mr-10 -mt-10",
            profilePicWrapper: "relative",
            profilePic: "w-32 h-32 rounded-full border-4 border-border-primary shadow-xl object-cover",
            ...
            fullName: "text-3xl font-bold text-text-primary mb-1",
            username: "text-accent-primary font-medium mb-4",
            eloBox: "inline-flex items-center gap-3 bg-bg-primary/50 px-4 py-2 rounded-xl border border-border-primary",
            eloLabel: "text-text-secondary text-sm uppercase tracking-wider font-semibold",
            eloValue: "text-2xl font-black text-text-primary",
            dashboardGrid: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4",
            statCard: "bg-bg-secondary-opaque rounded-xl p-5 border border-border-primary hover:bg-bg-tertiary transition-colors group",
            statIconBase: "mb-2",
            statIconSvg: "w-8 h-8 group-hover:scale-110 transition-transform",
            statLabel: "text-text-secondary text-sm font-medium",
            statValue: "text-3xl font-bold text-text-primary mt-1"
        };
            ...
            <div class="${styles.container}">
                ...
                <div class="${styles.dashboardGrid}">
                    ...
                    <div class="${styles.statCard}">
                        <div class="${styles.statIconBase} text-accent-primary">
                    ...
                    <!-- Victorias -->
                    <div class="${styles.statCard}">
                        <div class="${styles.statIconBase} text-success">
                    ...
                    <!-- Derrotas -->
                    <div class="${styles.statCard}">
                        <div class="${styles.statIconBase} text-danger">
                    ...
                    <!-- Goles Anotados -->
                    <div class="${styles.statCard}">
                        <div class="${styles.statIconBase} text-accent-hover">
