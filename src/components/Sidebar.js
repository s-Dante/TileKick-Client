                    ...
                    <ul class="${styles.ul}">
                        <li>
                            <a href="/profile" data-link class="${styles.linkBox}">
                                <span class="${styles.iconBox}">
                                    <svg class="${styles.iconSvg}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                                </span>
                        ...
                        <li>
                            <a href="/ranking" data-link class="${styles.linkBox}">
                                <span class="${styles.iconBox}">
                                    <svg class="${styles.iconSvg}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path></svg>
                                </span>
